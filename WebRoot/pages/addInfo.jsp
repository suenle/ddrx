	...
	<div id="keyword_id_areasTypeClassify_divAddFront" style="width: 85%; margin:0 auto;"  >
		<table  border="0" cellpadding="0" cellspacing="0" width="100%"
			...
			<tr style="height:20px;">
				...
				<td width="30%"><input type="checkbox" id="checkbox_c1" class="chk_3"
					style="display:none" /><label for="checkbox_c1"></label>
				</td>
				<td width="30%"><input class="input_class" type="text"
			...
			<tr style="height:20px;">
				...
				<td><div style="margin-right: 5px"><select class="input_class">
						<option>创世纪</option>
						<option></option>
				</select>
				</div>
			...
			<tr style="height:20px;">
				<td class=""><span class="div_front_prompt">*</span>个人祷告
				<br>15’：</td>
				...
				<td><input accept="middle" class="input_class" type="text"
					id="keyword_id_areasTypeClassify_areasTypeName" placeholder=" 时间/分钟" />
				</td>
			</tr>
			<tr style="height:20px;">
				<td class=""><span class="div_front_prompt">*</span>传福音时数
				<br>（同伴）：</td>
			...
			<tr style="height:20px;">
				<td class=""><span class="div_front_prompt">*</span>牧养、看望、
				<br>爱筵（同伴）：</td>
			...
			<tr style="height:20px;">
				<td class=""><span class="div_front_prompt">*</span>主日聚会
				<br>到会:</td>
